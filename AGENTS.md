...
that lives in [`../escrow/`](../escrow/) (mainnet
`umxj5-niaaa-aaaae-af2sq-cai`). The repo is **frontend-only**: the on-chain
escrow logic lives upstream and pandame talks to it directly via
`@dfinity/agent` actors generated from the canister's Candid interface.
...
## 4. Where to look (backend / escrow canister — `../escrow/`)

The Rust canister that powers PandaMe lives in [`../escrow/`](../escrow/).
**Do not** modify Rust under `src/declarations/**` here — those are
generated bindings.

| You're about to…                                          | Read                                                                                                         |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Understand the deal lifecycle / Tip flow / Two-party flow | [`../escrow/src/escrow/README.md`](../escrow/src/escrow/README.md), [`../escrow/TIPS.md`](../escrow/TIPS.md) |
| Touch the on-chain canister                               | Open `../escrow/`. Its API surface is defined by `src/escrow/escrow.did`.                                    |
